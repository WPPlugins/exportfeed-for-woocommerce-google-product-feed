...
class GCPF_PFeedSettingsDialogs
{
    ...
    static function fetchRefreshIntervalSelect()
    {
        ...
        GCPF_PFeedSettingsDialogs::formatIntervalOption(604800, '1 Week', $current_delay) . "\r\n" .
        GCPF_PFeedSettingsDialogs::formatIntervalOption(86400, '24 Hours', $current_delay) . "\r\n" .
        GCPF_PFeedSettingsDialogs::formatIntervalOption(43200, '12 Hours', $current_delay) . "\r\n" .
        GCPF_PFeedSettingsDialogs::formatIntervalOption(21600, '6 Hours', $current_delay) . "\r\n" .
        GCPF_PFeedSettingsDialogs::formatIntervalOption(3600, '1 Hour', $current_delay) . "\r\n" .
        GCPF_PFeedSettingsDialogs::formatIntervalOption(900, '15 Minutes', $current_delay) . "\r\n" .
        GCPF_PFeedSettingsDialogs::formatIntervalOption(300, '5 Minutes', $current_delay) . "\r\n" . '
					</select>';
    }
			  	...
			  	<div id="postbox-container-1" class="postbox-container">
			  		...
			  		<h3 class="hndle"></h3>
						<div class="inside export-target">
							<span class="dashicons dashicons-arrow-right"></span><b>Google feed will automatically update your feed after the interval set here.</b>
							<br/><br/>
							...
							<table class="form-table">
								<tbody>
									<tr>
										...
										<td style="width:59%;">' . GCPF_PFeedSettingsDialogs::fetchRefreshIntervalSelect() . '</td>
										<td><input class="button-primary" style="float:right;" type="submit" value="Update Interval" id="submit" name="submit" onclick="doUpdateSetting(\'selectDelay\', \'gcp_feed_delay\')"><div id="updateSettingMessage"></div></td>
									</tr>
								</tbody>
							</table>
						</div>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#cpf_filter_product_feed").change(function () {
            ...
            jQuery.ajax({
                type: "POST",
                url: "<?php echo GCPF_URL . "core/ajax/wp/fetch_feed_table.php" ?>",
