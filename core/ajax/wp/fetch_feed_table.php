...
if (!empty($list_of_feeds)) {
    ...
    <table class="widefat" style="margin-top:12px;">
        ...
        <tr>
            ...
            <!-- <th scope="col" width="50px"><?php //_e( 'View', 'gcpf-feed-strings' ); ?></th> -->
            <!-- <th scope="col" width="50px"><?php _e('Options', 'gcpf-feed-strings'); ?></th> -->
            <!-- <th scope="col" width="50px"><?php //_e( 'Delete', 'gcpf-feed-strings' ); ?></th> -->
        ...
        foreach (array_keys($seq) as $s) {
            ...
            ?>>
                ...
                <!--  <td><a href="<?php echo $this_feed['url'] ?>" target="_blank" class="purple_xmlsedit"><?php _e('View', 'gcpf-feed-strings'); ?></a></td>
                        <?php $url_edit = get_admin_url() . 'admin.php?page=gcpf-feed-admin&action=edit&id=' . $this_feed['id']; ?>
                        <td><a href="<?php echo($url_edit) ?>" class="purple_xmlsedit"><?php _e('Edit', 'gcpf-feed-strings'); ?></a></td>
                        <?php $url = get_admin_url() . 'admin.php?page=gcpf-feed-manage-page&action=delete&id=' . $this_feed['id']; ?>
                        <td><a href="<?php echo($url) ?>" class="purple_xmlsedit"><?php _e('Delete', 'gcpf-feed-strings'); ?></a></td>
                        <?php if ($this_feed['type'] == "eBaySeller") : ?>
                            <?php $upload_url = get_admin_url() . 'admin.php?page=gcpf-feed-admin&action=uploadFeed&id=' . $this_feed['id']; ?>
                            <td><a href="<?php echo($upload_url) ?>" class="purple_xmlsedit"><?php _e('Upload', 'gcpf-feed-strings'); ?></a></td>
                        <?php endif; ?>     -->
        ...
        <tr>
            ...
            <th scope="col" style="width: 80px;"><?php _e('Last Updated', 'gcpf-feed-strings'); ?></th>
            <!--  <th scope="col"><?php //_e( 'View', 'gcpf-feed-strings' ); ?></th> -->
            <!-- <th scope="col"><?php _e('Options', 'gcpf-feed-strings'); ?></th> -->
            <!-- <th scope="col"><?php //_e( 'Delete', 'gcpf-feed-strings' ); ?></th> -->
            <th scope="col"><?php _e('Products', 'gcpf-feed-strings'); ?></th>
        </tr>
        </tfoot>
