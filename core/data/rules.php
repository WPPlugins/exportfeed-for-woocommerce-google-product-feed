...
class GCPF_PFeedRule
{

    public $enabled = true;
    public $name = '';
    public $order = 200; //200 ~ GCPF_PActionBeforeFeed, therefore don't assign order > 299 (300 ~ GCPF_PActionAfterFeed)
...
class GCPF_PFeedRuleConcat extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleDescription extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleDiscount extends GCPF_PFeedRule
{
...
//***********************************************************
class GCPF_PFeedRuleFindAndSet extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleGooglecombotitle extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleGoogleexacttitle extends GCPF_PFeedRule
{
...
//***********************************************************
class GCPF_PFeedRulePricestandard extends GCPF_PFeedRule
{
...
class GCPF_PFeedRulePricerounding extends GCPF_PFeedRule
{
...
class GCPF_PFeedRulePricedecimalseparator extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleNoVariations extends GCPF_PFeedRule
{
...
//all categories
        if (in_array('*', $this->parameters)) {
            $this->parent_feed->addAttributeDefault('allcat', $this_parameter, 'GCPF_PCatVar');
        } //individual categories
        else {
            foreach ($this->parameters as $this_parameter)
                if (is_numeric($this_parameter))
                    $this->parent_feed->addAttributeDefault('xVar', $this_parameter, 'GCPF_PCatVar');
        }
    }
}

class GCPF_PFeedRulePricegroup extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleRemoveEmptyAttributes extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleShipping extends GCPF_PFeedRule
{
    ...
    public function initialize()
    {
        ...
        */
        ...
        if ($this->parent_feed->providerName == 'Google')
            $this->parent_feed->addAttributeDefault('shipping', 'none', 'GCPF_PGoogleShipping');
...
class GCPF_PFeedRuleStatusstandard extends GCPF_PFeedRule
{
...
class GCPF_PFeedRulePos extends GCPF_PFeedRule
{
// public function initialize() {
// 	$this->order = 190;
// }
...
//***********************************************************
class GCPF_PFeedRuleSetAll extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleStrlen extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleStrReplace extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleSubstr extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleTax extends GCPF_PFeedRule
{
    ...
    public function initialize()
    {
        ...
        if ($this->parent_feed->providerName == 'Google')
            $this->parent_feed->addAttributeDefault('tax', 'none', 'GCPF_PGoogleTax');
    }
...
class GCPF_PFeedRuleValidalways extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleWeightunit extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleDimensionunit extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleStrip_tags extends GCPF_PFeedRule
{
...
//***********************************************************
class GCPF_PFeedRuleRemoveAttributeCondition extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleCSVStandard extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleTSVStandard extends GCPF_PFeedRule
{
    //csvstandard should also elminiate characters outside \x20-\x7E ...what about other language chars? -cg
    public function initialize()
    {
 ...
 ***********/
class GCPF_PFeedRuleStrictAttribute extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleFindIdentifiers extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleGetSubcategory extends GCPF_PFeedRule
{
...
class GCPF_PFeedRuleGetPipedImages extends GCPF_PFeedRule
{
