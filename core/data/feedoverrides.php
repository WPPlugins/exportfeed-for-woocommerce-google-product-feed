...
class GCPF_PFeedOverride extends GCPF_PBaseFeedOverride
{
            ...
            foreach ($this->advancedCommands as $this_option) {
                ...
                switch ($command) {
                    ...
                    case 'setattribute':
                        ...
                        if (strtolower($params[2]) == 'default') {
                            if (isset($params[4]))
                                ...
                                $defaultClass = 'GCPF_PAttributeDefault';
                    ...
                    case 'setrapidcarttoken':
                        global $gfcore;
                        $gfcore->settingSet('cp_rapidcarttoken', $params[1]);
                        break;
