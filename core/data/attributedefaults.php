...
class GCPF_PActionAfterHarmonize extends GCPF_PAttributeDefault
{
...
class GCPF_PActionAfterLoad extends GCPF_PAttributeDefault
{
...
class GCPF_PActionBeforeFeed extends GCPF_PAttributeDefault
{
...
class GCPF_PActionAfterFeed extends GCPF_PAttributeDefault
{
...
class GCPF_PCategoryLookUp extends GCPF_PAttributeDefault
{
...
class GCPF_PCategoryTree extends GCPF_PActionBeforeFeed
{
...
//ex: setAttributeDefault xVar as 17 GCPF_PCatVar -- removes variations for category ID: 17
class GCPF_PCatVar extends GCPF_PActionAfterHarmonize
{
...
class GCPF_PConvertSpecialCharacters extends GCPF_PActionAfterFeed
{
...
class GCPF_PFirstFoundColor extends GCPF_PAttributeDefault
{
...
//setAttributeDefualt business-attribute as none GCPF_PGraziaBusinessRule
class GCPF_PGraziaBusinessRule extends GCPF_PActionBeforeFeed
{
...
class GCPF_PGoogleAdditionalImages extends GCPF_PActionAfterFeed
{
    ...
    public function postProcess($product, &$output)
    {
        ...
        global $gfcore;
        if ($gfcore->callSuffix != 'W' && $gfcore->callSuffix != 'We')
            return;
...
class GCPF_PGoogleShipping extends GCPF_PActionAfterFeed
{
...
class GCPF_PGoogleTax extends GCPF_PActionAfterFeed
{
 ...
 * example: setAttributeDefault screen-size as size GCPF_PMergeFields
 * woocommerce attributes takes precedence & depends on order of commands
 */
class GCPF_PMergeFields extends GCPF_PActionBeforeFeed
{
...
class GCPF_PSalePriceIfDefined extends GCPF_PActionBeforeFeed
{
...
class GCPF_PVaryOnId extends GCPF_PActionBeforeFeed
{
...
class GCPF_PVaryOnSku extends GCPF_PActionBeforeFeed
{
...
class GCPF_PRemoveZeroPricedItems extends GCPF_PActionBeforeFeed
{
