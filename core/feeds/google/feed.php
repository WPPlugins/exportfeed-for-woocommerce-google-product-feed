...
class GCPF_PGoogleFeed extends GCPF_PXMLFeed
{
    function __construct()
    {
        ...
        $this->addAttributeDefault('additional_images', 'none', 'GCPF_PGoogleAdditionalImages');
        $this->addAttributeDefault('tax_country', 'US');
        $this->addAttributeDefault('local_category', 'none', 'GCPF_PCategoryTree'); //store's local category tree
    ...
    function formatProduct($product)
    {
        ...
        if (isset($product->attributes['sale_price_dates_from']) && isset($product->attributes['sale_price_dates_to'])) {
            $product->attributes['sale_price_dates_from'] = $gfcore->localizedDate('Y-m-d\TH:iO', $product->attributes['sale_price_dates_from']);
            $product->attributes['sale_price_dates_to'] = $gfcore->localizedDate('Y-m-d\TH:iO', $product->attributes['sale_price_dates_to']);
